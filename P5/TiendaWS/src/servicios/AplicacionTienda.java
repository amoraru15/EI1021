...
/**
 * @author Instancia los objetos que ofrecen los servicios web que queremos que despliegue el servidor (p.e. Tomcat)
...
public class AplicacionTienda extends Application {
    private Set<Object> singletons = new HashSet<Object>();

    public AplicacionTienda() {
        singletons.add(new RecursoTienda());
    }
