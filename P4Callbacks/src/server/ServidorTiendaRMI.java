    ...
    public static void main(String args[]) {
        ...
        try {
           ...
           System.setSecurityManager(new SecurityManager());
            ...
            //Instacia un objeto remoto de ImplServidorTiendaRMI
            ImplServidorTiendaRMI exportedObj = new ImplServidorTiendaRMI();

            registryURL = "rmi://localhost:" + portNum + "/tienda";
            Naming.rebind(registryURL, exportedObj);
            System.out.println("Servidor registrado. Contiene:");
            // list names currently in the registry
            listRegistry(registryURL);
            System.out.println("Servidor listo.");
        }// end try
        catch (Exception re) {
            System.out.println("Exception in ServidorTiendaRMI.main: " + re);
        } // end catch
    } // end main
